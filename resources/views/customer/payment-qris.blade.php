...
<head>
    ...
    <title>BengkelConnect - Kode Booking</title>
...
<body>
    ...
    <div class="main-container">
        <div class="title-section">
            <h1>Kode Booking</h1>
            <p>Berikut detail booking Anda. Simpan kode booking dan tunggu konfirmasi dari admin.</p>
        </div>
        ...
        <div class="card">
            ...
            <div class="qris-footer-note">
                Simpan kode booking ini. Setelah pembayaran, mohon tunggu konfirmasi dari admin.
            </div>
